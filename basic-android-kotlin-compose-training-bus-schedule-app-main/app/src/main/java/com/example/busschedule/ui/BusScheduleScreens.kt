...
/*
 * Componible para BusScheduleDetails que muestra la lista de horarios de autobuses
 * Cuando [onScheduleClick] es nulo, [stopName] se reemplaza con un marcador de posición
 * como se supone, los [stopName] son los mismos que se muestran
 * en la visualización del encabezado de la lista en [BusScheduleScreen]
 */
@Composable
